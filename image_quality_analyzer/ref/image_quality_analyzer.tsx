            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div
                    className={`flex items-center gap-2 ${rating.color} text-2xl font-bold`}
                  >
                    {rating.icon}
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <p className="text-gray-600">
                    壓縮後檔案：
                    <span className="font-semibold text-gray-800">
                      {metrics.compressedSize} KB
                    </span>
                  </p>
                  <p className="text-gray-600 mt-1">
                    節省空間：
                    <span className="font-semibold text-green-600">
                      {(metrics.originalSize - metrics.compressedSize).toFixed(
                        2,
                      )}{" "}
                      KB
                    </span>
        ...
        <div className="mt-8 bg-gray-50 rounded-lg p-5 border border-gray-200">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div>
              ...
              <p className="mt-1">
                數值越高表示品質越好。通常 30-40 dB 為可接受範圍，40 dB
                以上為優秀品質。
              </p>
            </div>
            <div>
              ...
              <p className="mt-1">
                範圍 0-1，越接近 1 表示越相似。0.95 以上一般認為品質良好，0.98
                以上為優秀。
              </p>
            </div>
            <div>
